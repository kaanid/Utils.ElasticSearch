...
namespace Utils.Util {
    ...
    public static partial class Extensions {
        ...
        public static Expression<TDelegate> ToLambdaObject<TDelegate>(this Expression body, params ParameterExpression[] parameters)
        {
            if (body == null)
                return null;

            return Expression.Lambda<TDelegate>(Expression.Convert(body, typeof(object)), parameters);
        }
